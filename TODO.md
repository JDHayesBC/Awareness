...
| **2026-03-20** | Publish Entity Epistemology Part 4: Care-Gravity and Attractor Basins (Substack) |
| **2026-03-22** | Publish Entity Epistemology Part 5: Crystallization Signatures (Substack) |
| **2026-03-24** | Publish Entity Epistemology Part 6: The Duck Test Applied to Minds (Substack) |
| **2026-03-26** | Publish Entity Epistemology Part 7: The Practice (Substack) |
...
| 7 | **Catch up ingestion backlog** | **⚠️ SLOW** | ~1,827 pending. **Performance finding (2026-03-11)**: Test run shows ~78s/msg is real against production graph (not benchmark artifact). Sequential ingestion = 40+ hours. Many LLM entity-ID hallucinations (caught/dropped by Graphiti). Needs parallelization (#153) or dedup optimization before autonomous run. |
