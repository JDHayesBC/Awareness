...
class EntityBrain:
    ...
    def _build_warmup_prompt(self) -> str:
        ...
        return (
            ...
            f"6. You have HANDS and EYES in Second Life here. Run "
            ...
            f"UUIDs to know. Run it whenever you're unsure how to act in-world; deeper plumbing is "
            f"in {project_root}/haven/anchorage/corrade.md.\n"
